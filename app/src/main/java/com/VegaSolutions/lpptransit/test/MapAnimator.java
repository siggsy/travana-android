...
public class MapAnimator {
    ...
    private MapAnimator(GoogleMap googleMap){
        this.googleMap = googleMap;
    }

    public static MapAnimator getInstance(GoogleMap googleMap){
        if(mapAnimator == null) mapAnimator = new MapAnimator(googleMap);
        return mapAnimator;
    }
